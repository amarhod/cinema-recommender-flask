...
'''
	I grabbed these user_agents from here: https://techblog.willshouse.com/2012/01/03/most-common-user-agents/
	Then I just saved them into a list in a Python shell and ran the following little Python command
	for item in a_list : print "'" + item['useragent'].replace("\\", "") + "'" + ","
'''
